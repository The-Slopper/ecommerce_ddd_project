# Especificacao Tecnica — Ecommerce Ddd

| Campo | Valor |
|---|---|
| Repositorio | `ecommerce_ddd_project` |
...
Plataforma de e-commerce: catalogo, carrinho, checkout e pagamento. Este documento descreve requisitos, arquitetura e criterios de aceite.
